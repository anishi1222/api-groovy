...
1. Request Pipeline
    ...
    2. Remove some element from original API request
        - [Element Redaction](apip/ElementRedaction_RemoveElementFromAPIRequest.groovy)
        - [Remove JSON Array element(s) when some condition meets](apip/RemoveElementsFromJSONListInAPIRequest.groovy)
...
2. Response Pipeline
    ...
    2. Remove some element from original service response
        - [Element Redaction](apip/ElementRedaction_RemoveElementFromServiceResponse.groovy)
        - [Remove JSON Array element(s) when some condition meets](apip/RemoveElementsFromJSONListInServiceResponse.groovy)
...
1. Request Pipeline
    ...
    2. Remove some element from original API request
        - [Element Redaction](ocsg/ElementRedaction_RemoveElementFromAPIRequest.groovy)
        - [Remove JSON Array element(s) when some condition meets](ocsg/RemoveElementsFromJSONList.groovy)
...
2. Response Pipeline
    ...
    2. Remove some element from original service response
        - [Element Redaction](ocsg/ElementRedaction_RemoveElementFromServiceResponse.groovy)
        - [Remove JSON Array element(s) when some condition meets](ocsg/RemoveElementsFromJSONList.groovy)
